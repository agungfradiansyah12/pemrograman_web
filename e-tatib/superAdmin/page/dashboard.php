      ...
      <ul class="list-unstyled px-2 py-1">
        ...
        <li class="has-submenu">
            ...
            <ul class="submenu list-unstyled px-2 py-1">
                <li><a href="data1.php" class="text-decoration-none px-3 py-2 d-block">Data 1</a></li>
                <li><a href="data2.php" class="text-decoration-none px-3 py-2 d-block">Data 2</a></li>
                <li><a href="data3.php" class="text-decoration-none px-3 py-2 d-block">Data 3</a></li>
            </ul>
        </li>
        <li>
        <li>
